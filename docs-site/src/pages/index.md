...
The [`tests/test-project`](https://github.com/leighton-digital/cloud-blocks/tree/main/tests/test-project) directory contains working examples of all constructs in a real CDK application. These examples demonstrate best practices and can be used as a reference for your own implementations.

### Construct Examples

Each construct has a corresponding example file showing real-world usage:

- **[ApiCloudFrontDistribution](https://github.com/leighton-digital/cloud-blocks/blob/main/tests/test-project/lib/api-distribution-nested-stack.ts)** - API Gateway with CloudFront distribution, custom domain, SSL certificate, and monitoring
- **[ProgressiveLambda](https://github.com/leighton-digital/cloud-blocks/blob/main/tests/test-project/lib/progressive-lambda-nested-stack.ts)** - Lambda function with progressive deployment using AWS CodeDeploy
- **[RestApi](https://github.com/leighton-digital/cloud-blocks/blob/main/tests/test-project/lib/rest-api-nested-stack.ts)** - REST API Gateway with CloudWatch logging, CORS configuration, and observability
- **[IdempotencyTable](https://github.com/leighton-digital/cloud-blocks/blob/main/tests/test-project/lib/idempotency-table-nested-stack.ts)** - DynamoDB table optimized for idempotency patterns
- **[CloudWatchDashboard](https://github.com/leighton-digital/cloud-blocks/blob/main/tests/test-project/lib/cloudwatch-dashboard-nested-stack.ts)** - Centralized monitoring dashboard with custom widgets
- **[CustomStack](https://github.com/leighton-digital/cloud-blocks/blob/main/tests/test-project/lib/test-project-stack.ts)** - Extended Stack with built-in tagging, dashboard creation, and best practices
